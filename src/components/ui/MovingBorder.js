...
var MovingBorder = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", preserveAspectRatio: "none", className: "absolute h-full w-full", width: "100%", height: "100%" }, otherProps, { children: (0, jsx_runtime_1.jsx)("rect", { fill: "none", width: "100%", height: "100%", rx: rx, ry: ry, ref: pathRef }) })), (0, jsx_runtime_1.jsx)(framer_motion_1.motion.div, { style: {
                    position: "absolute",
                    top: 0,
                    left: 0,
