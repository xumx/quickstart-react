...
// Props documentation
// className: Additional classes for the SVG
// width: Width of the SVG
// height: Height of the SVG
// text: Text to display in the CPU chip
// showCpuConnections: Whether to show the CPU connections
// lineMarkerSize: Size of the line markers
// animateText: Whether to animate the text
// animateLines: Whether to animate the lines
// animateMarkers: Whether to animate the markers
